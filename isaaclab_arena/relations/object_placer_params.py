...
from isaaclab_arena.relations.placement_initializers import InitializerBase, OnTreeInitializer
...
class ObjectPlacerParams:
    ...
    initializer: InitializerBase = field(default_factory=OnTreeInitializer)
    """Strategy that seeds each candidate's starting positions before the solve.
    Swap in AnchorInitializer for the historical anchor-footprint seeding."""
