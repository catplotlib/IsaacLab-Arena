...
- Passed 116 focused tests covering policy replacement, serialization into a fresh process,
  CLI parsing, session exchange, action validation/scheduling, runner cleanup, and the
  existing OpenPI policy. The full simulation test suite was not run.
