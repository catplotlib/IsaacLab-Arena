...
_CABLE_CAMERA_POSITION = (0.3321266658713867, -0.06, 1.1526725658119235)
_CABLE_CAMERA_ROTATION_XYZW = (
    0.6408563820557885,
    0.6408563820557885,
    -0.2988362387301199,
    -0.2988362387301199,
...
class BimanualYamCameraCfg(ArenaCameraCfg):
    ...
    cable_camera: CameraCfg | None = None

    def use_cable_routing_rig(self) -> None:
        """Select the upstream overhead and oblique cable views."""
        self.top_camera = _d405_camera(
            "{ENV_REGEX_NS}/top_camera",
            position=(-0.0625, -0.06, 1.667),
            rotation_xyzw=_TOP_CAMERA_ROTATION_XYZW,
        )
        ...
        self.cable_camera = _d405_camera(
            ...
            rotation_xyzw=_CABLE_CAMERA_ROTATION_XYZW,
        )
