...
- PR bodies follow `.github/pull_request_template.md`. Explain the motivation and solution in plain English. Include a before/after example when usage changes, and state how the change was validated. Prefer concise paragraphs; use lists where they improve readability. Scale the detail to the change.
